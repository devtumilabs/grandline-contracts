...
import { TumiRegistry } from "./TumiRegistry.sol";
...
contract TumiContractFactory is Multicall, ERC2771Context, AccessControlEnumerable, IContractFactory {
    /// @dev Only FACTORY_ROLE holders can approve/unapprove implementations for proxies to point to.
    bytes32 public constant FACTORY_ROLE = keccak256("FACTORY_ROLE");

    TumiRegistry public immutable registry;
    ...
    constructor(address _trustedForwarder, address _registry) ERC2771Context(_trustedForwarder) {
        ...
        registry = TumiRegistry(_registry);
    }
    ...
    /// @dev Required override due to multiple inheritance of _contextSuffixLength.
