...
contract TumiRegistry is Multicall, ERC2771Context, AccessControlEnumerable {
    ...
    function getAt(address _deployer, uint256 _index) external view returns (address) {
        return deployments[_deployer].at(_index);
    }
