    ...
    NFTMetadata
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("LimitTokenERC721");
    ...
    ////   =====   Limit variables & events  =====

    /// @notice Count of how many a wallet has minted via signature.
    mapping(address => bool) public mintedBy;

    /// @dev Emitted when the max per wallet is reached.
    error AlreadyMinted();
    ...
    function initialize(
        ...
        __EIP712_init("LimitTokenERC721", "1");
    ...
    /// @notice Mints an NFT based on the provided mint request, enforcing the per-wallet minting limit.
