...
contract SoulboundTokenERC721 is
    Initializable,
    IThirdwebContract,
    IOwnable,
    IRoyalty,
    ...
    NFTMetadata
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("SoulboundTokenERC721");
    ...
    function initialize(
        ...
        __EIP712_init("SoulboundTokenERC721", "1");
